...
- 🚀 **多平台发布**: 一键同步发布到小红书/抖音/微信公众号/快手/B站/视频号
- 🔥 **热点采集**: 实时抓取微博/知乎/百度热搜榜,发现热门话题
- 📋 **文章复刻**: 抓取爆款文章,分析风格,批量生成同类内容
...
**Q: 热点采集显示空数据?**
A: 部分平台有反爬限制,正在使用 Playwright 绕过,后续版本会修复。

**Q: 文章复刻功能如何使用?**
A: 在 Web 面板「内容采集」页面输入文章链接,系统会自动抓取内容并分析风格,然后可以批量生成同类文章。
